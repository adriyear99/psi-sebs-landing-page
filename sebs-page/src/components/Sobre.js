...
function Sobre() {
    return (
        <div id="sobre" className="p-5">
            <div className="row">
                <section className="col-12 col-md-5 order-md-2 px-0 px-md-3 mb-5 mb-md-0  d-flex flex-wrap align-items-center">
                    <img src={require("../assets/sebs2.jpg")} alt="Sebastião Venâncio" className="imagem"/>
                </section>
                <section className="col-12 col-md-7 order-md-1 text-justify px-0 px-md-5">
